...
def checkConfig():
	...
	if sectionExists("Settings"):
		if (
				...
				sectionHasOption("Settings",'slot1') and sectionHasOption("Settings",'slot2') and sectionHasOption("Settings",'slot3') and sectionHasOption("Settings",'default_select_key_second_up')):
				str = "allright"
		else:
			return False
	else:
